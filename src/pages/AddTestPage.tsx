            ...
            >
              ...
              <div className="relative mb-4">
                ...
                <Input
                  ...
                  className="pl-10 bg-neutral-900/50 border-neutral-800 focus:border-amber-500/50 text-white placeholder:text-neutral-600"
                />
              </div>
              <ScrollArea className="flex-1 -mr-4 pr-4 h-[calc(100vh-250px)]">
